...
esp_err_t waveshare_esp32_s3_rgb_lcd_init() {
  ESP_LOGI(WAVESHARE_TAG,
           "Install RGB LCD panel driver"); // Log the start of the RGB LCD
  ...
  ESP_LOGI(WAVESHARE_TAG, "Initialize RGB LCD panel"); // Log the initialization
                                                       // of the RGB LCD panel
  ...
  ESP_LOGI(WAVESHARE_TAG, "Initialize GPIO"); // Log GPIO initialization
  gpio_init();                                // Initialize GPIO pins
  ESP_LOGI(WAVESHARE_TAG,
           "Initialize Touch LCD"); // Log touch LCD initialization
